            ...
            <Container fluid>
                <Row className="align-items-center justify-content-center banner">
                    ...
                    <Slide left>
                        ...
                        <h4>Creative a Frontend Developer</h4></Slide>
                        <a className="btn btn-primary" href="https://drive.google.com/u/0/uc?id=15dF8HhBlmNer18nwDbGCvhgi0klNVNUU&export=download">Download Resume</a>
                    </Col>
